                            ...
                            NextDynamicPatcherState::Turbopack { imports, .. } => {
                                ...
                                match (self.is_development, self.is_server) {
                                    (true, true) => {
                                        ...
                                        imports.push(TurbopackImport::WithDevelopmentTransition {
                                    ...
                                    (true, false) => {
                                        imports.push(TurbopackImport::WithDevelopmentId {
                                            id_ident: id_ident.clone(),
                                            specifier: dynamically_imported_specifier,
                                        });
                                    ...
                                    (false, true) => {
                                        ...
                                        imports.push(TurbopackImport::WithBuildTransition {
                                            id_ident: id_ident.clone(),
                                    ...
                                    (false, false) => {
                                        ...
                                        imports.push(TurbopackImport::WithBuildId {
                                            id_ident: id_ident.clone(),
                                            specifier: dynamically_imported_specifier.clone(),
                                        });
...
impl NextDynamicPatcher {
    fn maybe_add_dynamically_imported_specifier(&mut self, items: &mut Vec<ModuleItem>) {
        let NextDynamicPatcherState::Turbopack { dynamic_transition_name, imports } = &mut self.state else {
            return;
        };
        ...
        for import in std::mem::take(imports) {
            match import {
                TurbopackImport::WithDevelopmentTransition {
                    id_ident,
                    chunks_ident,
                    specifier,
                } => {
                ...
                TurbopackImport::WithDevelopmentId {
                    id_ident,
                    specifier,
                } => {
                ...
                TurbopackImport::WithBuildTransition {
                    id_ident,
                    specifier,
                } => {
